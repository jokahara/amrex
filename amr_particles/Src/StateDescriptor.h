...
#ifndef StateDescriptor_H_
#define StateDescriptor_H_
...
typedef void (*BndryFuncFabDefault) (Box const& bx, CellFab& data,
	...
	*/
	virtual void operator () (Real* data, const int* lo, const int* hi,
        ...
        */
        ...
        virtual void operator () (Box const& bx, CellFab& data,
                                  const int dcomp, const int numcomp,
                                  Geometry const& geom, const Real time,
                                  const Vector<BCRec>& bcr, const int bcomp,
